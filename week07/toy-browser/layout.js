...
function layout(element) {
  ...
  var items = elememt.children.filter((e) => e.type === 'elememt');
  ...
  if (!style.flexDirenction || style.flexDirenction === 'auto') {
    style.flexDirenction = 'row';
  }
  ...
  if (style.flexDirenction === 'row-reverse') {
    mainSize = 'width';
    mainStart = 'right';
    mainEnd = 'left';
    mainSign = -1;
  ...
  if (style.flexDirenction === 'column') {
    mainSize = 'height';
    mainStart = 'top';
    mainEnd = 'bottom';
    mainSign = +1;
  ...
  if (style.flexDirenction === 'column-reverse') {
    mainSize = 'height';
    mainStart = 'bottom';
    mainEnd = 'top';
    mainSign = -1;
